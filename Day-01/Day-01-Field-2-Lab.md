# Day 01: Network Models & OSI Reference (Field 2: Geomagnetic)

## 0. Metadata

- **Objective:** Prove Network Models & OSI Reference functionality in Geomagnetic (Field 2) constraints
...
- **Prerequisites:** Day 01 base lab manual + Field 2 environment setup
...
- **Key Concepts:** Field-optimized Network Models & OSI Reference, Geomagnetic-specific validation, proof obligations, real-world constraints

## 1. Business Context

Geomagnetic storms (Kp index 8-9) cause ionospheric disturbances that affect satellite and terrestrial links.
This lab simulates **space-weather stress** on Network Models & OSI Reference:
...
- Test: Does Network Models & OSI Reference converge within SLA under stress?
...
- Test Network Models & OSI Reference convergence time under stress

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.01.0/24 | 10.0.01.1 | /24 | Field 2 core router |
...
PC1# ping 10.0.01.2 -c 100 > /tmp/baseline.log &
...
**Why add jitter instead of just reducing bandwidth for Network Models & OSI Reference?**
...
- Validates: Network Models & OSI Reference survives real geomagnetic storms
