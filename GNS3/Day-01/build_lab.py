#!/usr/bin/env python3
"""
GNS3 automation script for Day 01 - Network Devices & Enterprise Topology.

Builds the New York / Tokyo branch topology from Labs/Day-01-Network-Devices.md
using free, open-source images:
    ...
    Firewalls (FW1, FW2)  pfSense
    PCs / Servers         Linux (Alpine)
...
PROJECT_NAME = "Day-01-Network-Devices"

# Templates this lab needs, keyed by the name GNS3 shows them under.
# download_url is only used if the user opts in when a template is missing.
REQUIRED_TEMPLATES = {
    "VyOS": {
        "download_url": "https://s3.amazonaws.com/s3-us.vyos.io/rolling/current/vyos-rolling-latest.iso",
        "note": "Router role (R1, R2). Open-source, Cisco-like CLI.",
    },
    "pfSense CE": {
        "download_url": "https://atxfiles.netgate.com/mirror/downloads/",
        "note": "Firewall role (FW1, FW2). Netgate requires selecting a "
        "specific release/arch from their downloads page manually — "
        "this cannot be fully automated due to their download form.",
    },
    "Alpine Linux": {
        "download_url": "https://dl-cdn.alpinelinux.org/alpine/latest-stable/releases/x86_64/",
        "note": "End devices (PCs, servers, attacker). Lightweight full Linux.",
    },
    "Open vSwitch": {
        "download_url": None,
...
# Positions are x,y canvas coordinates purely for layout.
NODES = [
    # New York Branch
    {"name": "PC0", "template": "Alpine Linux", "x": -400, "y": -200},
    {"name": "PC1", "template": "Alpine Linux", "x": -400, "y": -100},
    {"name": "SW1", "template": "Open vSwitch", "x": -250, "y": -150},
    {"name": "R1", "template": "VyOS", "x": -100, "y": -150},
    {"name": "FW1", "template": "pfSense CE", "x": 50, "y": -150},
    # Internet
    {"name": "Internet", "template": "VyOS", "x": 200, "y": 0},
    # Tokyo Branch
    {"name": "Server1", "template": "Alpine Linux", "x": -400, "y": 200},
    {"name": "Server2", "template": "Alpine Linux", "x": -400, "y": 300},
    {"name": "SW2", "template": "Open vSwitch", "x": -250, "y": 250},
    {"name": "FW2", "template": "pfSense CE", "x": -100, "y": 250},
    {"name": "R2", "template": "VyOS", "x": 50, "y": 250},
    # Attacker
    {"name": "Attacker", "template": "Alpine Linux", "x": 400, "y": 0},
]
...
def main():
    ...
    print(
        f"\nDay 01 topology built in project '{PROJECT_NAME}'. "
