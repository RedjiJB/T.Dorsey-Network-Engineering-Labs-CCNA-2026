# Day 08: Static Routing (Field 2: Geomagnetic)

## 0. Metadata

- **Objective:** Prove Static Routing functionality in Geomagnetic (Field 2) constraints
...
- **Prerequisites:** Day 08 base lab manual + Field 2 environment setup
...
- **Key Concepts:** Field-optimized Static Routing, Geomagnetic-specific validation, proof obligations, real-world constraints

## 1. Business Context

Geomagnetic storms (Kp index 8-9) cause ionospheric disturbances that affect satellite and terrestrial links.
This lab simulates **space-weather stress** on Static Routing:
...
- Test: Does Static Routing converge within SLA under stress?
...
- Test Static Routing convergence time under stress

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.08.0/24 | 10.0.08.1 | /24 | Field 2 core router |
...
PC1# ping 10.0.08.2 -c 100 > /tmp/baseline.log &
...
**Why add jitter instead of just reducing bandwidth for Static Routing?**
...
- Validates: Static Routing survives real geomagnetic storms
