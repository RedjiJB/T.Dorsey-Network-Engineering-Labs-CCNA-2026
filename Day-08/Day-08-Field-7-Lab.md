# Day 08: Static Routing (Field 7: Haiti)

## 0. Metadata

- **Objective:** Prove Static Routing functionality in Haiti (Field 7) constraints
...
- **Prerequisites:** Day 08 base lab manual + Field 7 environment setup
...
- **Key Concepts:** Field-optimized Static Routing, Haiti-specific validation, proof obligations, real-world constraints

## 1. Business Context

Haiti deployment combines all constraints: offline-first operation, geomagnetic stress, distributed governance, and scale.
This lab proves Static Routing works at **production scale** (50-1000+ nodes) under **all constraints combined**:
...
**Why this matters:** Haiti P38/P45/P52+ deployments must handle real-world chaos. Static Routing is foundational to mission success.
...
- Test Static Routing convergence time at each scale
...
- Test Static Routing with offline-first design, stress injection, Byzantine tolerance

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.08.0/24 | 10.0.08.1 | /24 | Field 7 core router |
...
Router(config-if)# ip address 10.0.08.2 255.255.255.0
...
- Proves: Static Routing scales in Haiti deployment model
...
- Test: This lab validates Static Routing at 50-node scale with all constraints
...
- Test: Static Routing proven at production scale (1000+ nodes)

**This lab progression (P38 → P45 → P52) proves:**
- Static Routing is deployment-ready for Haiti
