# Day 12: Basic Routing (Inter-VLAN) (Field 7: Haiti)

## 0. Metadata

- **Objective:** Prove Basic Routing (Inter-VLAN) functionality in Haiti (Field 7) constraints
...
- **Prerequisites:** Day 12 base lab manual + Field 7 environment setup
...
- **Key Concepts:** Field-optimized Basic Routing (Inter-VLAN), Haiti-specific validation, proof obligations, real-world constraints

## 1. Business Context

Haiti deployment combines all constraints: offline-first operation, geomagnetic stress, distributed governance, and scale.
This lab proves Basic Routing (Inter-VLAN) works at **production scale** (50-1000+ nodes) under **all constraints combined**:
...
**Why this matters:** Haiti P38/P45/P52+ deployments must handle real-world chaos. Basic Routing (Inter-VLAN) is foundational to mission success.
...
- Test Basic Routing (Inter-VLAN) convergence time at each scale
...
- Test Basic Routing (Inter-VLAN) with offline-first design, stress injection, Byzantine tolerance

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.12.0/24 | 10.0.12.1 | /24 | Field 7 core router |
...
- Proves: Basic Routing (Inter-VLAN) scales in Haiti deployment model
...
- Test: This lab validates Basic Routing (Inter-VLAN) at 50-node scale with all constraints
...
- Test: Basic Routing (Inter-VLAN) proven at production scale (1000+ nodes)

**This lab progression (P38 → P45 → P52) proves:**
- Basic Routing (Inter-VLAN) is deployment-ready for Haiti
