# Day 12: Basic Routing (Inter-VLAN) (Field 2: Geomagnetic)

## 0. Metadata

- **Objective:** Prove Basic Routing (Inter-VLAN) functionality in Geomagnetic (Field 2) constraints
...
- **Prerequisites:** Day 12 base lab manual + Field 2 environment setup
...
- **Key Concepts:** Field-optimized Basic Routing (Inter-VLAN), Geomagnetic-specific validation, proof obligations, real-world constraints

## 1. Business Context

Geomagnetic storms (Kp index 8-9) cause ionospheric disturbances that affect satellite and terrestrial links.
This lab simulates **space-weather stress** on Basic Routing (Inter-VLAN):
...
- Test: Does Basic Routing (Inter-VLAN) converge within SLA under stress?
...
- Test Basic Routing (Inter-VLAN) convergence time under stress

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.12.0/24 | 10.0.12.1 | /24 | Field 2 core router |
...
PC1# ping 10.0.12.2 -c 100 > /tmp/baseline.log &
...
**Why add jitter instead of just reducing bandwidth for Basic Routing (Inter-VLAN)?**
...
- Validates: Basic Routing (Inter-VLAN) survives real geomagnetic storms
