# Day 07: Router Configuration (Field 2: Geomagnetic)

## 0. Metadata

- **Objective:** Prove Router Configuration functionality in Geomagnetic (Field 2) constraints
...
- **Prerequisites:** Day 07 base lab manual + Field 2 environment setup
...
- **Key Concepts:** Field-optimized Router Configuration, Geomagnetic-specific validation, proof obligations, real-world constraints

## 1. Business Context

Geomagnetic storms (Kp index 8-9) cause ionospheric disturbances that affect satellite and terrestrial links.
This lab simulates **space-weather stress** on Router Configuration:
...
- Test: Does Router Configuration converge within SLA under stress?
...
- Test Router Configuration convergence time under stress

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.07.0/24 | 10.0.07.1 | /24 | Field 2 core router |
...
PC1# ping 10.0.07.2 -c 100 > /tmp/baseline.log &
...
**Why add jitter instead of just reducing bandwidth for Router Configuration?**
...
- Validates: Router Configuration survives real geomagnetic storms
