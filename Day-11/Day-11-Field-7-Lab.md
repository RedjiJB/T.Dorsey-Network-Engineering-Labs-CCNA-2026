# Day 11: VLAN Basics (Field 7: Haiti)

## 0. Metadata

- **Objective:** Prove VLAN Basics functionality in Haiti (Field 7) constraints
...
- **Prerequisites:** Day 11 base lab manual + Field 7 environment setup
...
- **Key Concepts:** Field-optimized VLAN Basics, Haiti-specific validation, proof obligations, real-world constraints

## 1. Business Context

Haiti deployment combines all constraints: offline-first operation, geomagnetic stress, distributed governance, and scale.
This lab proves VLAN Basics works at **production scale** (50-1000+ nodes) under **all constraints combined**:
...
**Why this matters:** Haiti P38/P45/P52+ deployments must handle real-world chaos. VLAN Basics is foundational to mission success.
...
- Test VLAN Basics convergence time at each scale
...
- Test VLAN Basics with offline-first design, stress injection, Byzantine tolerance

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.11.0/24 | 10.0.11.1 | /24 | Field 7 core router |
...
- Proves: VLAN Basics scales in Haiti deployment model
...
- Test: This lab validates VLAN Basics at 50-node scale with all constraints
...
- Test: VLAN Basics proven at production scale (1000+ nodes)

**This lab progression (P38 → P45 → P52) proves:**
- VLAN Basics is deployment-ready for Haiti
