# Day 03: IPv4 Addressing & Subnetting (Field 2: Geomagnetic)

## 0. Metadata

- **Objective:** Prove IPv4 Addressing & Subnetting functionality in Geomagnetic (Field 2) constraints
...
- **Prerequisites:** Day 03 base lab manual + Field 2 environment setup
...
- **Key Concepts:** Field-optimized IPv4 Addressing & Subnetting, Geomagnetic-specific validation, proof obligations, real-world constraints

## 1. Business Context

Geomagnetic storms (Kp index 8-9) cause ionospheric disturbances that affect satellite and terrestrial links.
This lab simulates **space-weather stress** on IPv4 Addressing & Subnetting:
...
- Test: Does IPv4 Addressing & Subnetting converge within SLA under stress?
...
- Test IPv4 Addressing & Subnetting convergence time under stress

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.03.0/24 | 10.0.03.1 | /24 | Field 2 core router |
...
PC1# ping 10.0.03.2 -c 100 > /tmp/baseline.log &
...
**Why add jitter instead of just reducing bandwidth for IPv4 Addressing & Subnetting?**
...
- Validates: IPv4 Addressing & Subnetting survives real geomagnetic storms
