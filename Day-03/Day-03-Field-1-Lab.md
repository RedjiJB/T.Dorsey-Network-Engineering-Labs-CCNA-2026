# Day 03: IPv4 Addressing & Subnetting (Field 1: Black Start)

## 0. Metadata

- **Objective:** Prove IPv4 Addressing & Subnetting functionality in Black Start (Field 1) constraints
...
- **Prerequisites:** Day 03 base lab manual + Field 1 environment setup
...
- **Key Concepts:** Field-optimized IPv4 Addressing & Subnetting, Black Start-specific validation, proof obligations, real-world constraints

## 1. Business Context

Haiti P38 pilot sites experience frequent power losses (avg. 6 hours/day) and unreliable internet.
This lab validates that IPv4 Addressing & Subnetting works in **offline-only mode**:
...
**Why this matters:** Operators in remote areas cannot rely on central management. IPv4 Addressing & Subnetting must work autonomously.
...
- Test: Can IPv4 Addressing & Subnetting survive power loss? Is state recovered from cache?
...
- Test IPv4 Addressing & Subnetting in "dark mode" (no external dependencies)
...
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.03.0/24 | 10.0.03.1 | /24 | Field 1 core router |
...
! Static routes only
Router(config)# ip route 10.0.03.0 255.255.255.0 10.0.03.1
...
PC1# ping 10.0.03.10
Reply from 10.0.03.10: bytes=32 time=5ms
...
**Why offline-only topology for IPv4 Addressing & Subnetting?**
...
The offline-only design proves IPv4 Addressing & Subnetting works **without** these dependencies:
...
- Validates: IPv4 Addressing & Subnetting is truly offline-capable for Haiti deployment
...
4. IPv4 Addressing & Subnetting works autonomously without cloud sync
...
- Success: IPv4 Addressing & Subnetting validated for real Haiti deployment
