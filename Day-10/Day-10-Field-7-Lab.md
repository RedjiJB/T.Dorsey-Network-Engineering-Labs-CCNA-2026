# Day 10: Hands-On Lab: IPv4 Fundamentals (Field 7: Haiti)

## 0. Metadata

- **Objective:** Prove Hands-On Lab: IPv4 Fundamentals functionality in Haiti (Field 7) constraints
...
- **Prerequisites:** Day 10 base lab manual + Field 7 environment setup
...
- **Key Concepts:** Field-optimized Hands-On Lab: IPv4 Fundamentals, Haiti-specific validation, proof obligations, real-world constraints

## 1. Business Context

Haiti deployment combines all constraints: offline-first operation, geomagnetic stress, distributed governance, and scale.
This lab proves Hands-On Lab: IPv4 Fundamentals works at **production scale** (50-1000+ nodes) under **all constraints combined**:
...
**Why this matters:** Haiti P38/P45/P52+ deployments must handle real-world chaos. Hands-On Lab: IPv4 Fundamentals is foundational to mission success.
...
- Test Hands-On Lab: IPv4 Fundamentals convergence time at each scale
...
- Test Hands-On Lab: IPv4 Fundamentals with offline-first design, stress injection, Byzantine tolerance

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.10.0/24 | 10.0.10.1 | /24 | Field 7 core router |
...
- Proves: Hands-On Lab: IPv4 Fundamentals scales in Haiti deployment model
...
- Test: This lab validates Hands-On Lab: IPv4 Fundamentals at 50-node scale with all constraints
...
- Test: Hands-On Lab: IPv4 Fundamentals proven at production scale (1000+ nodes)

**This lab progression (P38 → P45 → P52) proves:**
- Hands-On Lab: IPv4 Fundamentals is deployment-ready for Haiti
