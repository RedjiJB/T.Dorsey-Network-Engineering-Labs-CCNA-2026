# Day 10: Hands-On Lab: IPv4 Fundamentals (Field 2: Geomagnetic)

## 0. Metadata

- **Objective:** Prove Hands-On Lab: IPv4 Fundamentals functionality in Geomagnetic (Field 2) constraints
...
- **Prerequisites:** Day 10 base lab manual + Field 2 environment setup
...
- **Key Concepts:** Field-optimized Hands-On Lab: IPv4 Fundamentals, Geomagnetic-specific validation, proof obligations, real-world constraints

## 1. Business Context

Geomagnetic storms (Kp index 8-9) cause ionospheric disturbances that affect satellite and terrestrial links.
This lab simulates **space-weather stress** on Hands-On Lab: IPv4 Fundamentals:
...
- Test: Does Hands-On Lab: IPv4 Fundamentals converge within SLA under stress?
...
- Test Hands-On Lab: IPv4 Fundamentals convergence time under stress

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.10.0/24 | 10.0.10.1 | /24 | Field 2 core router |
...
PC1# ping 10.0.10.2 -c 100 > /tmp/baseline.log &
...
**Why add jitter instead of just reducing bandwidth for Hands-On Lab: IPv4 Fundamentals?**
...
- Validates: Hands-On Lab: IPv4 Fundamentals survives real geomagnetic storms
