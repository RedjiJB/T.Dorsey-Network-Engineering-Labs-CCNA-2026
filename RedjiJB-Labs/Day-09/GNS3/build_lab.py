#!/usr/bin/env python3
"""
GNS3 automation script for Day 09 - Interface Configuration & Device Management.

Builds the router/two-switch/four-PC topology from
Labs/Day-09-Interface-configuration-&-Device-Managment.md using free,
open-source images:
...
PROJECT_NAME = "Day-09-Interface-Configuration"
...
NODES = [
    ...
    {"name": "PC3", "template": "Alpine Linux", "x": 400, "y": -150},
    {"name": "PC4", "template": "Alpine Linux", "x": 400, "y": -50},
]
...
def main():
    ...
    print(
        f"\nDay 09 topology built in project '{PROJECT_NAME}'. "
        "Open it in the GNS3 GUI to start the nodes. Open vSwitch does not "
        "expose Cisco-style 'speed'/'duplex' interface sub-commands through "
        "the GNS3 GUI - use 'ovs-vsctl' on the GNS3 host to inspect/adjust "
        "virtual link parameters, and practice descriptions/unused-port "
        "disabling concepts against this build alongside the companion "
        "manual's IOS command walkthrough."
    )
