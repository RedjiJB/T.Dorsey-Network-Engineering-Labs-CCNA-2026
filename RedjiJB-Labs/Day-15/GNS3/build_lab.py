#!/usr/bin/env python3
"""
GNS3 automation script for Day 15 - VLSM & Static Routing.

Builds the two-router VLSM topology from RedjiJB-Labs/Day-15/Day-15-Lab-Manual.md
using free, open-source images:

    Role                  Image
    --------------------  ----------------------------
    Routers (R1, R2)      VyOS
    PCs (PC1-PC4)         Linux (Alpine)

No switches are required for this lab -- each PC connects directly to its
router's LAN interface, matching the original Packet Tracer topology.
...
PROJECT_NAME = "Day-15-VLSM-Static-Routing"
...
REQUIRED_TEMPLATES = {
    ...
    "Alpine Linux": {
        ...
        "note": "End devices (PC1-PC4). Lightweight full Linux.",
    },
}
...
NODES = [
    ...
    {"name": "PC3", "template": "Alpine Linux", "x": 200, "y": -150},
    {"name": "PC4", "template": "Alpine Linux", "x": 200, "y": -50},
]
...
def main():
    ...
    print(
        f"\nDay 15 topology built in project '{PROJECT_NAME}'. "
