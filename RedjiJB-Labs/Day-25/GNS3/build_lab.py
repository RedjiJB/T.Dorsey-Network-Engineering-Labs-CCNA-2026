#!/usr/bin/env python3
"""
GNS3 automation script for Day 25 - EIGRP Multi-Autonomous System, Auto-Summary,
and Unequal-Cost Load Balancing.

Builds the R1/R2/R3/R4 partial-mesh topology from
Labs/Day-25-EIGRP-Multi-Autonomous System...md using free, open-source images:
...
PROJECT_NAME = "Day-25-EIGRP"

REQUIRED_TEMPLATES = {
    "VyOS": {
        "download_url": "https://s3.amazonaws.com/s3-us.vyos.io/rolling/current/vyos-rolling-latest.iso",
        "note": "Router role (R1, R2, R3, R4). Supports EIGRP-equivalent (VyOS uses FRR; note EIGRP support varies by version -- check your VyOS build).",
    },
    "Open vSwitch": {
        "download_url": None,
...
def main():
    ...
    print(
        f"\nDay 25 topology built in project '{PROJECT_NAME}'. "
