#!/usr/bin/env python3
"""
GNS3 automation script for Day 50 - DHCP Snooping.

Builds the R1 (DHCP server) / SW1 / SW2 / PC1 topology from
RedjiJB-Labs/Day-50/Day-50-Lab-Manual.md using free, open-source images:
...
IMPORTANT LIMITATION: Open vSwitch does not implement Cisco `ip dhcp
snooping`. See README.md for how to approximate binding-table behavior.
...
PROJECT_NAME = "Day-50-DHCP-Snooping"
...
REQUIRED_TEMPLATES = {
    ...
    "Open vSwitch": {
        ...
        "Does NOT support ip dhcp snooping - see README.md.",
    },
}
...
def main():
    ...
    print(
        f"\nDay 50 topology built in project '{PROJECT_NAME}'. "
        "Remember: Open vSwitch does not enforce DHCP snooping - see README.md."
    )
