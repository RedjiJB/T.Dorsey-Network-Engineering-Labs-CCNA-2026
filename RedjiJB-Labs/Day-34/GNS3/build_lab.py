#!/usr/bin/env python3
"""
GNS3 automation script for Day 34 - Standard ACLs with OSPF-Routed Connectivity.

Builds a two-router, four-subnet topology using free, open-source images:
...
PROJECT_NAME = "Day-34-Standard-ACLs-OSPF"

REQUIRED_TEMPLATES = {
    "VyOS": {
        "download_url": "https://s3.amazonaws.com/s3-us.vyos.io/rolling/current/vyos-rolling-latest.iso",
        "note": "Router role (R1, R2). Supports OSPF and firewall rule-sets (ACL equivalent).",
    },
    "Alpine Linux": {
...
def main():
    ...
    print(
        f"\nDay 34 topology built in project '{PROJECT_NAME}'. "
