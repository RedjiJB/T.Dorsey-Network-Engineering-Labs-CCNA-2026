#!/usr/bin/env python3
"""
GNS3 automation script for Day 47 - QoS, DSCP Marking & Traffic Classification.

Builds the R1/R2 QoS topology from RedjiJB-Labs/Day-47/Day-47-Lab-Manual.md
...
Note: VyOS QoS syntax (`set traffic-policy shaper ...`) differs from Cisco IOS
class-map/policy-map. See README.md for the concept mapping.
"""
...
NODES = [
    ...
    {"name": "SRV1", "template": "Alpine Linux", "x": 250, "y": 0},
]
...
def main():
    ...
    print(
        f"\nDay 47 topology built in project '{PROJECT_NAME}'. "
