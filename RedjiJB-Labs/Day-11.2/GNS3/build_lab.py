#!/usr/bin/env python3
"""
GNS3 automation script for Day 11.2 - Configuring Static Routes.

Builds a 3-router line topology (R1 - R2 - R3) with a LAN switch and PC
on each end, using free, open-source images:
...
PROJECT_NAME = "Day-11.2-Troubleshooting-Static-Routes"

REQUIRED_TEMPLATES = {
    "VyOS": {
        "download_url": "https://s3.amazonaws.com/s3-us.vyos.io/rolling/current/vyos-rolling-latest.iso",
        "note": "Router role (R1, R2, R3). Open-source, Cisco-like CLI.",
    },
    "Alpine Linux": {
...
NODES = [
    ...
    {"name": "R2", "template": "VyOS", "x": 50, "y": 0},
    {"name": "R3", "template": "VyOS", "x": 200, "y": 0},
    {"name": "SW2", "template": "Open vSwitch", "x": 350, "y": 0},
...
def main():
    ...
    print(
        f"\nDay 11.2 topology built in project '{PROJECT_NAME}'. "
