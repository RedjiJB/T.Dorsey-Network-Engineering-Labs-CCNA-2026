#!/usr/bin/env python3
"""
GNS3 automation script for Day 32 - IPv6 Addressing: EUI-64, Link-Local, and Static Routes.

Builds a two-router, two-LAN topology connected by a link-local-only WAN link,
...
NODES = [
    ...
    {"name": "R1", "template": "VyOS", "x": -150, "y": -100},
    {"name": "R2", "template": "VyOS", "x": 150, "y": -100},
    {"name": "SW2", "template": "Open vSwitch", "x": 350, "y": -100},
    {"name": "PC2", "template": "Alpine Linux", "x": 500, "y": -100},
]

LINKS = [
    ("PC1", "SW1"),
    ("SW1", "R1"),
    ("R1", "R2"),  # link-local-only WAN link
    ("R2", "SW2"),
    ("SW2", "PC2"),
]
...
def main():
    ...
    print(
        f"\nDay 32 topology built in project '{PROJECT_NAME}'. "
