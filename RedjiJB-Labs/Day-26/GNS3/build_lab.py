#!/usr/bin/env python3
"""
GNS3 automation script for Day 26 - OSPF ASBR Default Route Injection and
Passive Interface Design.

Builds the ISPR1/R1/R2/R3/R4 topology from
Labs/Day-26-OSPF-ASBR-Default-Route-Injection...md using free, open-source
images:
...
PROJECT_NAME = "Day-26-OSPF-ASBR"

REQUIRED_TEMPLATES = {
    "VyOS": {
        "download_url": "https://s3.amazonaws.com/s3-us.vyos.io/rolling/current/vyos-rolling-latest.iso",
        "note": "Router role (ISPR1, R1, R2, R3, R4). Open-source, Cisco-like CLI, supports OSPF.",
    },
    "Open vSwitch": {
        "download_url": None,
...
def main():
    ...
    print(
        f"\nDay 26 topology built in project '{PROJECT_NAME}'. "
