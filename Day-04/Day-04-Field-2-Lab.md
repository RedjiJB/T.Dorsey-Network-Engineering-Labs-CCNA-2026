# Day 04: IPv4 Routing Fundamentals (Field 2: Geomagnetic)

## 0. Metadata

- **Objective:** Prove IPv4 Routing Fundamentals functionality in Geomagnetic (Field 2) constraints
...
- **Prerequisites:** Day 04 base lab manual + Field 2 environment setup
...
- **Key Concepts:** Field-optimized IPv4 Routing Fundamentals, Geomagnetic-specific validation, proof obligations, real-world constraints

## 1. Business Context

Geomagnetic storms (Kp index 8-9) cause ionospheric disturbances that affect satellite and terrestrial links.
This lab simulates **space-weather stress** on IPv4 Routing Fundamentals:
...
- Test: Does IPv4 Routing Fundamentals converge within SLA under stress?
...
- Test IPv4 Routing Fundamentals convergence time under stress

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.04.0/24 | 10.0.04.1 | /24 | Field 2 core router |
...
PC1# ping 10.0.04.2 -c 100 > /tmp/baseline.log &
...
**Why add jitter instead of just reducing bandwidth for IPv4 Routing Fundamentals?**
...
- Validates: IPv4 Routing Fundamentals survives real geomagnetic storms
