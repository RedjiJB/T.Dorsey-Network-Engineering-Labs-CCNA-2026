# Day 04: IPv4 Routing Fundamentals (Field 7: Haiti)

## 0. Metadata

- **Objective:** Prove IPv4 Routing Fundamentals functionality in Haiti (Field 7) constraints
...
- **Prerequisites:** Day 04 base lab manual + Field 7 environment setup
...
- **Key Concepts:** Field-optimized IPv4 Routing Fundamentals, Haiti-specific validation, proof obligations, real-world constraints

## 1. Business Context

Haiti deployment combines all constraints: offline-first operation, geomagnetic stress, distributed governance, and scale.
This lab proves IPv4 Routing Fundamentals works at **production scale** (50-1000+ nodes) under **all constraints combined**:
...
**Why this matters:** Haiti P38/P45/P52+ deployments must handle real-world chaos. IPv4 Routing Fundamentals is foundational to mission success.
...
- Test IPv4 Routing Fundamentals convergence time at each scale
...
- Test IPv4 Routing Fundamentals with offline-first design, stress injection, Byzantine tolerance

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.04.0/24 | 10.0.04.1 | /24 | Field 7 core router |
...
Router(config-if)# ip address 10.0.04.2 255.255.255.0
...
- Proves: IPv4 Routing Fundamentals scales in Haiti deployment model
...
- Test: This lab validates IPv4 Routing Fundamentals at 50-node scale with all constraints
...
- Test: IPv4 Routing Fundamentals proven at production scale (1000+ nodes)

**This lab progression (P38 → P45 → P52) proves:**
- IPv4 Routing Fundamentals is deployment-ready for Haiti
