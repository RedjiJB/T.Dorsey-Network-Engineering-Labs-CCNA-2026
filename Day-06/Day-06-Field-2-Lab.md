# Day 06: Switch Configuration (Field 2: Geomagnetic)

## 0. Metadata

- **Objective:** Prove Switch Configuration functionality in Geomagnetic (Field 2) constraints
...
- **Prerequisites:** Day 06 base lab manual + Field 2 environment setup
...
- **Key Concepts:** Field-optimized Switch Configuration, Geomagnetic-specific validation, proof obligations, real-world constraints

## 1. Business Context

Geomagnetic storms (Kp index 8-9) cause ionospheric disturbances that affect satellite and terrestrial links.
This lab simulates **space-weather stress** on Switch Configuration:
...
- Test: Does Switch Configuration converge within SLA under stress?
...
- Test Switch Configuration convergence time under stress

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.06.0/24 | 10.0.06.1 | /24 | Field 2 core router |
...
PC1# ping 10.0.06.2 -c 100 > /tmp/baseline.log &
...
**Why add jitter instead of just reducing bandwidth for Switch Configuration?**
...
- Validates: Switch Configuration survives real geomagnetic storms
