# Day 05: Switch Basics & VLANs (Intro) (Field 7: Haiti)

## 0. Metadata

- **Objective:** Prove Switch Basics & VLANs (Intro) functionality in Haiti (Field 7) constraints
...
- **Prerequisites:** Day 05 base lab manual + Field 7 environment setup
...
- **Key Concepts:** Field-optimized Switch Basics & VLANs (Intro), Haiti-specific validation, proof obligations, real-world constraints

## 1. Business Context

Haiti deployment combines all constraints: offline-first operation, geomagnetic stress, distributed governance, and scale.
This lab proves Switch Basics & VLANs (Intro) works at **production scale** (50-1000+ nodes) under **all constraints combined**:
...
**Why this matters:** Haiti P38/P45/P52+ deployments must handle real-world chaos. Switch Basics & VLANs (Intro) is foundational to mission success.
...
- Test Switch Basics & VLANs (Intro) convergence time at each scale
...
- Test Switch Basics & VLANs (Intro) with offline-first design, stress injection, Byzantine tolerance

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.05.0/24 | 10.0.05.1 | /24 | Field 7 core router |
...
Router(config-if)# ip address 10.0.05.2 255.255.255.0
...
- Proves: Switch Basics & VLANs (Intro) scales in Haiti deployment model
...
- Test: This lab validates Switch Basics & VLANs (Intro) at 50-node scale with all constraints
...
- Test: Switch Basics & VLANs (Intro) proven at production scale (1000+ nodes)

**This lab progression (P38 → P45 → P52) proves:**
- Switch Basics & VLANs (Intro) is deployment-ready for Haiti
