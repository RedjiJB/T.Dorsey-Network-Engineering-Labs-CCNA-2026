# Day 05: Switch Basics & VLANs (Intro) (Field 2: Geomagnetic)

## 0. Metadata

- **Objective:** Prove Switch Basics & VLANs (Intro) functionality in Geomagnetic (Field 2) constraints
...
- **Prerequisites:** Day 05 base lab manual + Field 2 environment setup
...
- **Key Concepts:** Field-optimized Switch Basics & VLANs (Intro), Geomagnetic-specific validation, proof obligations, real-world constraints

## 1. Business Context

Geomagnetic storms (Kp index 8-9) cause ionospheric disturbances that affect satellite and terrestrial links.
This lab simulates **space-weather stress** on Switch Basics & VLANs (Intro):
...
- Test: Does Switch Basics & VLANs (Intro) converge within SLA under stress?
...
- Test Switch Basics & VLANs (Intro) convergence time under stress

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.05.0/24 | 10.0.05.1 | /24 | Field 2 core router |
...
PC1# ping 10.0.05.2 -c 100 > /tmp/baseline.log &
...
**Why add jitter instead of just reducing bandwidth for Switch Basics & VLANs (Intro)?**
...
- Validates: Switch Basics & VLANs (Intro) survives real geomagnetic storms
