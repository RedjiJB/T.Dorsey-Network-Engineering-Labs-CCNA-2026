# Day 02: Ethernet & MAC Addressing (Field 7: Haiti)

## 0. Metadata

- **Objective:** Prove Ethernet & MAC Addressing functionality in Haiti (Field 7) constraints
...
- **Prerequisites:** Day 02 base lab manual + Field 7 environment setup
...
- **Key Concepts:** Field-optimized Ethernet & MAC Addressing, Haiti-specific validation, proof obligations, real-world constraints

## 1. Business Context

Haiti deployment combines all constraints: offline-first operation, geomagnetic stress, distributed governance, and scale.
This lab proves Ethernet & MAC Addressing works at **production scale** (50-1000+ nodes) under **all constraints combined**:
...
**Why this matters:** Haiti P38/P45/P52+ deployments must handle real-world chaos. Ethernet & MAC Addressing is foundational to mission success.
...
- Test Ethernet & MAC Addressing convergence time at each scale
...
- Test Ethernet & MAC Addressing with offline-first design, stress injection, Byzantine tolerance

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.02.0/24 | 10.0.02.1 | /24 | Field 7 core router |
...
Router(config-if)# ip address 10.0.02.2 255.255.255.0
...
- Proves: Ethernet & MAC Addressing scales in Haiti deployment model
...
- Test: This lab validates Ethernet & MAC Addressing at 50-node scale with all constraints
...
- Test: Ethernet & MAC Addressing proven at production scale (1000+ nodes)

**This lab progression (P38 → P45 → P52) proves:**
- Ethernet & MAC Addressing is deployment-ready for Haiti
