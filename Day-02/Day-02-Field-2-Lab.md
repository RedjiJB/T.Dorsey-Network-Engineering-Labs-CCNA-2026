# Day 02: Ethernet & MAC Addressing (Field 2: Geomagnetic)

## 0. Metadata

- **Objective:** Prove Ethernet & MAC Addressing functionality in Geomagnetic (Field 2) constraints
...
- **Prerequisites:** Day 02 base lab manual + Field 2 environment setup
...
- **Key Concepts:** Field-optimized Ethernet & MAC Addressing, Geomagnetic-specific validation, proof obligations, real-world constraints

## 1. Business Context

Geomagnetic storms (Kp index 8-9) cause ionospheric disturbances that affect satellite and terrestrial links.
This lab simulates **space-weather stress** on Ethernet & MAC Addressing:
...
- Test: Does Ethernet & MAC Addressing converge within SLA under stress?
...
- Test Ethernet & MAC Addressing convergence time under stress

## 3. IP Addressing Plan

| Device | Role | Subnet | Address | Mask | Notes |
|--------|------|--------|---------|------|-------|
| R1 | Primary | 10.0.02.0/24 | 10.0.02.1 | /24 | Field 2 core router |
...
PC1# ping 10.0.02.2 -c 100 > /tmp/baseline.log &
...
**Why add jitter instead of just reducing bandwidth for Ethernet & MAC Addressing?**
...
- Validates: Ethernet & MAC Addressing survives real geomagnetic storms
